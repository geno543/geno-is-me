      ...
      <div className="mx-auto max-w-[760px] px-6 pb-20 pt-5 sm:px-8">
        ...
        {isProjectsPage ? (
            ...
            <section data-reveal>
              <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: '1rem' }}>
                ...
                <img
                  ...
                  alt="Clyde McBride"
                  style={{ height: '130px', width: 'auto', objectFit: 'contain', objectPosition: 'bottom', opacity: 0.88, flexShrink: 0, pointerEvents: 'none' }}
                  loading="lazy"
                />
              </div>
            </section>
          ...
          <main id="top">
            ...
            <section aria-label="Clyde accent" style={{ position: 'relative', height: '0' }}>
